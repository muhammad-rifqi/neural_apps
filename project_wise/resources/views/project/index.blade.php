        ...
        <form id="predictionForm" class="space-y-8">
            ...
            <div class="card bg-white p-6 rounded-xl border border-gray-200">
                <h2 class="text-xl font-bold text-gray-700 mb-6 flex items-center">
                    <svg class="icon mr-2 text-blue-500" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="projectName"
                            ...
                            value="Implementasi Sistem Akuntansi X">
                    </div>
                    ...
                    <div class="input-group">
                        <label for="totalBudget" class="block mb-1 text-sm text-gray-600">Anggaran Pokok (Rp/Unit)
                            *</label>
                    ...
                    <div class="input-group">
                        <label for="additionalCost" class="block mb-1 text-sm text-gray-600">Dana Kontingensi (Rp/Unit)
                            *</label>
            ...
            <div class="card bg-white p-6 rounded-xl border border-gray-200">
                <h2 class="text-xl font-bold text-gray-700 mb-6 flex items-center">
                    <svg class="icon mr-2 text-purple-500" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                ...
                <div id="techContainer" class="space-y-4">
                    ...
                    <div class="tech-input grid grid-cols-4 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <select class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            title="Kategori Teknologi">
                            <!-- Options filled by JS -->
                        </select>
                        <input type="text" class="col-span-2 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Nama Spesifik (e.g., React, Python)" value="React">
                        <button type="button" onclick="removeDynamicInput(this)"
                            class="col-span-1 bg-red-500 hover:bg-red-600 text-white text-sm font-semibold rounded-lg">Hapus</button>
                    </div>
                    <div class="tech-input grid grid-cols-4 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <select class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            title="Kategori Teknologi">
                        ...
                        <input type="text" class="col-span-2 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Nama Spesifik (e.g., React, Python)" value="PostgreSQL">
                        <button type="button" onclick="removeDynamicInput(this)"
                            class="col-span-1 bg-red-500 hover:bg-red-600 text-white text-sm font-semibold rounded-lg">Hapus</button>
                    </div>
                </div>
                <button type="button" onclick="addTechnology()"
                    class="mt-4 w-full p-2 bg-purple-500 text-white font-semibold rounded-lg hover:bg-purple-600 transition duration-150">
                    + Tambah Teknologi
                </button>
            </div>
            ...
            <div class="card bg-white p-6 rounded-xl border border-gray-200">
                <h2 class="text-xl font-bold text-gray-700 mb-6 flex items-center">
                    <svg class="icon mr-2 text-green-500" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                ...
                <div id="teamContainer" class="space-y-4">
                    ...
                    <div class="team-input grid grid-cols-5 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <input type="text" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Nama Role" value="Project Manager">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Qty" min="1" value="1">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Expertise (1-5)" min="1" max="5" value="4">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Avg Salary" min="1000" value="12000">
                        <button type="button" onclick="removeDynamicInput(this)"
                            class="col-span-1 bg-red-500 hover:bg-red-600 text-white text-sm font-semibold rounded-lg">Hapus</button>
                    </div>
                    <div class="team-input grid grid-cols-5 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <input type="text" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Nama Role" value="Developer">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Qty" min="1" value="3">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Expertise (1-5)" min="1" max="5" value="3">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Avg Salary" min="1000" value="7000">
                        <button type="button" onclick="removeDynamicInput(this)"
                            class="col-span-1 bg-red-500 hover:bg-red-600 text-white text-sm font-semibold rounded-lg">Hapus</button>
                    </div>
                </div>
                <button type="button" onclick="addTeamMember()"
                    class="mt-4 w-full p-2 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-150">
                    + Tambah Anggota Tim
                </button>
            </div>
            ...
            <div class="card bg-white p-6 rounded-xl border border-gray-200">
                <h2 class="text-xl font-bold text-gray-700 mb-6 flex items-center">
                    <svg class="icon mr-2 text-red-500" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path
                ...
                <div id="riskContainer" class="space-y-4">
                    ...
                    <div class="risk-input grid grid-cols-5 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <select class="col-span-2 p-2 border border-gray-300 rounded-lg text-sm"
                            title="Jenis Kategori Risiko">
                            <!-- Options filled by JS -->
                        </select>
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Dampak (1-5)" min="1" max="5" value="4">
                        <input type="number" class="col-span-1 p-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Kemungkinan (1-5)" min="1" max="5" value="3">
                        <button type="button" onclick="removeDynamicInput(this)"
                            class="col-span-1 bg-red-500 hover:bg-red-600 text-white text-sm font-semibold rounded-lg">Hapus</button>
                    </div>
                </div>
                <button type="button" onclick="addRisk()"
                    class="mt-4 w-full p-2 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600 transition duration-150">
                    + Tambah Risiko
                </button>
            </div>

            <button type="submit"
                class="w-full py-3 bg-blue-600 text-white text-lg font-bold rounded-xl hover:bg-blue-700 transition duration-300">
